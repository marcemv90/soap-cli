...
<p align="center">
  <img src="img/soap-cli-logo-01.png" alt="soap-cli logo" width="40%" />
</p>
...
This produces `target/soap-cli.jar` which includes all dependencies.
...
```bash
java -jar soap-cli.jar --endpoint https://example.com/soap --request-file request.xml
```
